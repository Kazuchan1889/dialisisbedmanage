...
export default function Lantai3Page() {
  ...
  const clearAllBeds = async () => {
    if (!confirm('AWAS! Anda yakin ingin mengosongkan SEMUA bed di Lantai 3 khusus pada HARI INI? Jadwal esok hari tidak akan terhapus.')) return;
    ...
    try {
      ...
      const res = await fetch('/api/beds/clear', {
        ...
        body: JSON.stringify({ floor: 3, date: todayStr })
      });
      if (!res.ok) throw new Error('Gagal mengosongkan bed');
      alert('Semua bed di Lantai 3 pada hari ini berhasil dikosongkan.');
      fetchBeds();
    } catch (e: any) {
      alert(e.message);
    }
    ...
    <>
      ...
      <div className="page-container">
        ...
        <div className="mobile-legend">
          ...
          <div className="legend-item"><div className="legend-dot" style={{ background: '#fffbeb', border: '1.5px solid #fde68a' }} />Perawatan / Repair ({stats.repair})</div>
        </div>
        ...
        <div className="floor-map-container">
          ...
          <div style={{ minWidth: 720 }}>
            ...
            <div style={{ display: 'flex', gap: 16, alignItems: 'stretch', marginBottom: 20 }}>
              ...
              {/* Korteks Room — Right (3 beds in 2x3 grid layout) */}
              <div className="bed-section" style={{ flex: 1, padding: 12, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
